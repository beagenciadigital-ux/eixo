...
/** Short display name (menus, hero, footer) */
export const BRAND_NAME = 'Eixo do Mal'
/** Full title with version — keep in sync with server `oldConifg.ts` */
export const GAME_TITLE = `${BRAND_NAME} ${GAME_VERSION}`
/** mailto for support; override with NEXT_PUBLIC_CONTACT_EMAIL */
export const CONTACT_EMAIL =
	process.env.NEXT_PUBLIC_CONTACT_EMAIL || "admin@eixodomal.local"
