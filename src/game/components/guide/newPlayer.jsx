        ...
        <Container className="dwarf0 elf0 gremlin0 drow0 ghoul0 gnome0 pixie0 minotaur0 goblin0 orc0 hobbit0 vampire0">
            ...
            <Stack mt='sm'>
                ...
                {empire.turnsUsed <= turnsProtection && (<Text>
                    You are the founder of a new empire in the world of Eixo do Mal. You are in the protection period until you have used {turnsProtection} turns. This means that you cannot be attacked by other players. You can use this time to learn the game and build up your empire.
                </Text>)}
                <Text>
