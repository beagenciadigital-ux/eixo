...
export default function Signup()
{
	...
	const formatRegisterError = (err) => {
		...
		if (msg === 'Network Error') return t('auth:apiUnreachable')
		const first = Object.values(err).find((v) => typeof v === 'string')
		return first ?? t('auth:apiUnreachable')
	}
				...
				<Stack align='center'>
					<Paper className={classes.form} radius={0} >
						...
						>
							...
							<Text color='red' align='center' mt='md'>{error}</Text>
