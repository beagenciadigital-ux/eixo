...
const ERA_NAMES = ['past', 'present', 'future']

const getRaceSummary = (empire) =>
{
	const race = raceArray[empire.race]
	const eraName = ERA_NAMES[empire.era]
	if (!race || !eraName) return '/images/summaries/default.webp'
	return `/images/summaries/race/${race.name.toLowerCase()}${eraName}.webp`
}
