...
const getRounds = async (req: Request, res: Response) => {
	try {
		const rounds = await getRoundHistoryRepo().find({
			order: {
				createdAt: 'DESC',
			},
		})
...
const getEmpireHistory = async (req: Request, res: Response) => {
	...
	try {
		const empireHistory = await getEmpireHistoryRepo().find({
...
const getClanHistory = async (req: Request, res: Response) => {
	...
	try {
		const clanHistory = await getClanHistoryRepo().find({
...
const getOneEmpireHistory = async (req: Request, res: Response) => {
	...
	try {
		const empireHistory = await getEmpireHistoryRepo().findOne({
...
const getHistory = async (req: Request, res: Response) => {
	...
	try {
		const roundHistory = await getRoundHistoryRepo().findOne({
